...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-20 h-20 mx-auto bg-[#fcfcfc] rounded-full shadow-sm justify-center items-center inline-flex">
        <svg
      ...
      <div className="mt-4">
        ...
        <p className="text-center text-[#575757] text-sm font-normal leading-snug pb-4">
          {description}
        </p>
      </div>
    </div>
